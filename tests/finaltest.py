...
class Parent:
    ...
    def itsme(self):
        print("itsme() - in Parent object is running")
        print(self.House, self.money)
        
    def mychild(self):
        print("mychild() in Parent object is running")
        print(print(self.House))
        
        
class Child(Parent):
    def itsme(self):
        print("Child()- Child object is running")
        Parent().mychild()
...
obj = Iterator(0,10)
#obj = Iterator(empList, 10)
for val in obj:
    print(val)

#####################3/16/20173##################
    
emp1 = ['1' , 'Gary Gebreslassie', 90000]
emp2 = ['2', 'Ann', 609955]
emp3 = ['3', 'Nolawi', 60000]
...
class empIterator:
    ...
    def __next__(self):
        empnext = self.empli[self.counter]
...
empIterObj = empIterator(empList)

for obj in empIterObj:
    try:
        print(obj)
    except IndexError :
        break
...
#consume = consumer()
#consume.__next__()
#Then you can manually call consume.send(3) from IPython Console
'''
def Consumer():
    try:
        while True:
